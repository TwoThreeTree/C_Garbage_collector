...
static MemBlock *memBlockStart = NULL; // start of linked list of blocks allocated
static MemBlock *memBlockEnd = NULL;   // end of linked list of blocks allocated
static int numBlocks = 0;              // number of blocks allocated
...
// a better way to do this would be to hash our reference number
